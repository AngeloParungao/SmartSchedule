...
function Sections() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isUpdating) {
      axios
        .put(`${url}api/sections/update/${sectionIdToUpdate}`, sectionData)
        .then((res) => {
      ...
      axios
        .post(`${url}api/sections/adding`, sectionData)
        .then((res) => {
          //FOR ACTIVITY HISTORY
          axios.post(`${url}api/activity/adding`, {
            user_id: currentUser,
  ...
  const handleSelectAll = () => {
    if (selectedSectionIds.length === filteredSections.length) {
      ...
      setSelectedSectionIds(
        filteredSections.map((section) => section.section_id)
      );
    }
  };
  ...
  const handlePasswordSubmit = (password) => {
    if (password === user.password) {
      axios
        .delete(`${url}api/sections/delete`, {
      ...
      <div className="sections-container">
        ...
        <div>
          <div className="upper-table">
            ...
            <div className="btns">
              <button id="select-all-btn" onClick={handleSelectAll}>
                Select All
              </button>
              <button id="delete-btn" onClick={handleDeleteSelected}>
                Remove Section/s
              </button>
              <PasswordPrompt
                  ...
                  <tr key={section.section_id}>
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          handleCheckboxChange(e, section.section_id)
                        }
                      />
                    </td>
