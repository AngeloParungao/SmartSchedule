...
function Subjects() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isUpdating) {
      axios
        .put(`${url}api/subjects/update/${subjectIdToUpdate}`, subjectData)
        .then((res) => {
  ...
  const handleSelectAll = () => {
    if (selectedSubjectIds.length === filteredSubjects.length) {
      ...
      setSelectedSubjectIds(
        filteredSubjects.map((subject) => subject.subject_id)
      );
    }
  };
  ...
  const handlePasswordSubmit = (password) => {
    if (password === user.password) {
      ...
      axios
        .delete(`${url}api/subjects/delete`, {
                  ...
                  <tr key={subject.subject_id}>
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          handleCheckboxChange(e, subject.subject_id)
                        }
                      />
                    </td>
