...
function Scheduling() {
  ...
  const handleItemAdded = async (newItem) => {
    ...
    if (
      newItem.section_name === selectedSection &&
      newItem.section_group === selectedGroup
    ) {
      ...
      <div className="scheduling-container">
        <div className="controls">
          ...
          <div className="scheduling-btns">
            ...
            <button className="edit-item-btn" onClick={handleUpdateItemClick}>
              Edit Item
            </button>
            <button className="delete-item-btn" onClick={handleDeleteItemClick}>
              Delete Item
            </button>
          </div>
        </div>
                ...
                <tr key={time.startTime}>
                  <td>
                    <span className="time">
                      ...
                      {time.endTime.slice(0, 2) < 12 ? "AM" : "PM"}
                    </span>
                  </td>
          ...
          {sortedSchedules.map((schedule) => (
            ...
            >
              <div className="update-details-left">
                <span
                  style={{
                    color: isDarkBackground(schedule.background_color)
                      ? "white"
                      : "black",
                  }}
                >
