...
function Sidebar() {
  ...
  const showSidebar = () => {
    ...
    document.querySelector(".sidebar-action").style.borderTopRightRadius =
      "1rem";
    document.querySelector(".sidebar-action").style.borderBottomRightRadius =
      "1rem";
  ...
  const closeSidebar = () => {
    document.querySelector(".sidebar-action").style.marginLeft = "0";
    document.querySelector(".sidebar-action").style.backgroundColor =
      "transparent";
          ...
          <div>
            {user.map((user) => {
              if (user.user_id === currentUser) {
                return (
                  <span className="initial">{user.username.charAt(0)}</span>
                );
              }
            })}
          </div>
